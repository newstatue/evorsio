...
export function TitleBar() {
    const windowButtonClass = "h-full w-12 rounded-none [--wails-draggable:no-drag] active:not-aria-[haspopup]:translate-y-0"

    return (
        <header className="flex h-(--titlebar-height) shrink-0 items-center bg-sidebar [--wails-draggable:drag]">
            <div className="flex items-center">
                <Menubar className="border-0 rounded-sm font-normal [--wails-draggable:no-drag]">
                    <MenubarMenu>
